...
This is a list of Effect.pac IDs in both vanilla Brawl and enabled by the Effect.pac Roster Expansion System.
...
## Custom Effect.pac IDs

The below Effect.pac IDs are provided by the Effect.pac Roster Expansion System and are not part of the vanilla game.
