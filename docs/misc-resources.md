...
- [JOJI's Site](http://ssbbhack.web.fc2.com/index.html) by JOJI - A site with data on many aspects of Brawl, especially soundbanks and effect banks.
...
- [Creating Franchise Icon Models](guides/franchise-model-guide.md) - A guide on creating models for your franchise icons which are used on the results screen.